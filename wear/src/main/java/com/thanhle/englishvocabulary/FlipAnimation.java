...
public class FlipAnimation extends Animation {
	...
	public FlipAnimation(float from_degrees, float to_degrees, float x_center,
			float y_center, boolean yaxis) {
	...
	public void setCenterRotationPoint(float x_center, float y_center) {
		m_CenterX = x_center;
		m_CenterY = y_center;
	}
	...
	protected void applyTransformation(float interpolatedTime, Transformation t) {
		float degrees = m_FromDegrees
				+ ((m_ToDegrees - m_FromDegrees) * interpolatedTime);
