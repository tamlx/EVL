...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * @param processorForDiscCache      null-ok; {@linkplain com.nostra13.universalimageloader.core.process.BitmapProcessor Bitmap processor} which process images before saving them in disc cache
		 */
