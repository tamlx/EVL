...
public class ImageViewAware implements ImageAware {
	 ...
	 * {@inheritDoc}
	 * <p/>
	 * Width is defined by target {@link android.widget.ImageView view} parameters, configuration
	 ...
	 * {@inheritDoc}
	 * <p/>
	 * Height is defined by target {@link android.widget.ImageView view} parameters, configuration
	 * parameters or device display dimensions.<br />
	 * Size computing algorithm:<br />
