...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.nostra13.universalimageloader.core.assist.MemoryCacheUtil#generateKey(String, com.nostra13.universalimageloader.core.assist.ImageSize) image key} (used in memory cache). */
