...
/**
 * TextView with auto resize text size to fit with view
 * 
 * @author thanh.lecaominh
 *
 */
public class TextViewAutoResizeSingleline extends TextView {
	...
	public TextViewAutoResizeSingleline(Context context) {
		super(context);
		init();
	}

	public TextViewAutoResizeSingleline(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
